...
class Result(Base):
    ...
    session_id: Mapped[Optional[int]] = mapped_column(ForeignKey("session.id", ondelete="CASCADE"), nullable=True)
    ...
    sessions = relationship("Session", back_populates="results")
    questions = relationship("Question", back_populates="results")
